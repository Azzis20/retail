...
<body>
    ...
    <div class="header">
        ...
        <div class="header-title">@yield('page-title', 'Customer Panel')</div>
    </div>
    ...
    <nav class="sidebar" id="sidebar">
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="{{ route('customer.product.index') }}" class="nav-link {{ request()->routeIs('customer.product*') ? 'active' : '' }}">
                    <i class="fa-solid fa-carrot"></i> Product
                </a>
            </li>
             
            <li class="nav-item">
                <a href="{{ route('customer.order.index') }}" class="nav-link {{ request()->routeIs('customer.order*') ? 'active' : '' }}">
                   <i class="fa-solid fa-basket-shopping"></i> Order
                </a>
            </li>
             
            <li class="nav-item">
                <a href="{{ route('customer.bill.index') }}" class="nav-link {{ request()->routeIs('customer.bill*') ? 'active' : '' }}">
                    <i class="fa-solid fa-wallet"></i> Bill
                </a>
            </li>
             
            <li class="nav-item">
                <a href="{{ route('customer.profile.index', ['id' => auth()->id()] ) }}" class="nav-link {{ request()->routeIs('customer.profile*') ? 'active' : '' }}">
