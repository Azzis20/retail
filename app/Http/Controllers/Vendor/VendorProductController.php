...
class VendorProductController extends Controller
{
     ...
     public function index()
    {
        ...
        return view('vendor.product.product-index',compact('products'))->with('category', 'all');
    }
    ...
    {
        //
        return view('vendor.product.product-create');
    }
    ...
    public function search(Request $request){
        ...
        $search = $request->input('search');
            ...
            ->paginate(5);
        return view('vendor.product.product-index', compact('products'))->with('category','search');
    }
    ...
    public function selectVegetable()
    {
        ...
        return view('vendor.product.product-index', compact('products'))->with('category', 'vegetable');
    }
    ...
    public function selectGrocery()
    {
        ...
        return view('vendor.product.product-index', compact('products'))->with('category', 'grocery');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('vendor.product.product-edit', compact('product'));
    }
        ...
        public function filterByStock(Request $request)
{
    ...
    return view('vendor.product.product-index', compact('products'))
        ->with('category', 'all')
